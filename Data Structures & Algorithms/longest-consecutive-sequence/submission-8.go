// i still didn't finished this with hashmap method, as i think it can be finished by array
// although it's n log n, but yea i have to train my hash map logic
